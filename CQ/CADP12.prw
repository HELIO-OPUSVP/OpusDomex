...
// Maximizacao da tela em rela็ใo a area de trabalho
	...
	If nOpc == 4  //Altera็ใo
		If P12->P12_STATUS == "2" .And. !(__CUSERID $ GetMV("MV_XREGREC"))
			MsgInfo("Este Registro de Reclama็ใo / Ocorr๊ncia esta encerrado e nใo pode ser alterado!")
			Return
		EndIf
	EndIf
	...
	If  nOpc == 5  //Exclusใo
		If !(__CUSERID $ GetMV("MV_XREGREC"))
			MsgInfo("Voc๊ nใo tem permissใo para excluir um Registro de Reclama็ใo / Ocorr๊ncia.")
			Return
		EndIf
	EndIf
...
//	@ nSuperior,nMemoEsquerda MsGet oOrigDesc Var cOrigDesc Picture "@!" Size nMemoDireita,10 Of oFolder:aDialogs[nPosFolบฑฑCADP14LOkder] When .F. Pixel
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑบออออออออออุออออออออออุอออออออุอออออออออออออออออออออออุออออออุออออออออออบฑฑ
ฑฑบPrograma  บ CAD14TOK บAutor  บFelipe Aur้lio de Melo บ Data บ 14/07/13 บฑฑ
ฑฑบออออออออออุออออออออออออออออออฯอออออออออออออออออออออออออออฯอออออออออออออบฑฑ
ฑฑบDesc.     บ                                                            บฑฑ
ฑฑบ          บ                                                            บฑฑ
ฑฑบออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออบฑฑ
...
User Function XDmxClaCh(nTipo,cCampo)
	...
	Local cDescri
	Local cCombo
	Local cRet := "1=Sup.N1;2=Sup.N2 2T;3=Suporte N3 OpusVP;4=Melhoria;5=Projeto;6=Suporte N3 Outros;7=Aguardando envio Opus;8=Obriga็๕es;9-Sup.N2 1T"
	Default nTipo := 1
...
//dbSelectArea(“SX3”)
	...
	If SX3->(dbSeek( cCampo )  )
		If nTipo == 3 //Se for Engenharia
			...
			cRet := "1=Sup.N1;2=Sup.N2 2T;3=Suporte N3 OpusVP;4=Melhoria;5=Projeto;6=Suporte N3 Outros;7=Aguardando envio Opus;8=Obriga็๕es;9-Sup.N2 1T"
			If Alltrim(SX3->X3_CBOX) <> Alltrim(cRet ) .And. Alltrim(SX3->X3_CAMPO) == Alltrim(cCampo)
				If Reclock("SX3",.F.)
					SX3->X3_CBOX := cRet
					SX3->(MsUnlock())
