...
±±ºPrograma  ³DOMACW31  ºAutor  ³Michel A. Sander    º Data ³  01/11/17   º±±
...
DEFINE MSDIALOG oTrans TITLE OemToAnsi("Entrega de Bobina para Produção") FROM 0,0 TO 450,302 PIXEL OF oMainWnd PIXEL
