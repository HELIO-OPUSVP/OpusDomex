...
cQuery := "SELECT * FROM "+RetSqlName("SZA")+" WHERE ZA_PRODUTO <> '50010100' AND ZA_SALDO <> 0 AND D_E_L_E_T_ = '' ORDER BY ZA_DATA DESC, ZA_HORA DESC "
...
cQuery := "SELECT * FROM "+RetSqlName("SZE")+" WHERE ZE_SALDO <> 0 AND D_E_L_E_T_ = '' ORDER BY ZE_DATA DESC, ZE_HORA DESC "
...
//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
cQuery := "SELECT * FROM "+RetSqlName("SZX")+" WHERE ZX_SALDO <> 0 AND D_E_L_E_T_ = '' ORDER BY ZX_DATA DESC, ZX_HORA DESC "
