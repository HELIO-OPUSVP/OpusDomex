...
Local cAviso	:= "Este programa ira imprimir um Relatório de corte por bobina"
Local cPar      := ""
...
oReport := TReport():New(cPerg,"Relatório de corte por bobina", cPerg, {|oReport| ReportPrint(oReport,@cAliasRep,cPar)}, cAviso)
//oReport:nFontBody := 9
oReport:SetPortrait
...
//³ Sessao 1 (oLinha)                                            ³
//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
oLinha := TRSection():New(oReport,"Relatório de corte por bobina", {cAliasRep})       
