...
±±ºPrograma  ³MRSSX5    ºAutor  ³Microsiga           º Data ³  12/10/18   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³                                                            º±±
±±º          ³   Chamada:   u_MRSSX5("21", "Grupos de tributação")        º±±
...
Static Function ModelDef()
    ...
    oStSX5:SetProperty('X5_CHAVE',    MODEL_FIELD_VALID,   FwBuildFeature(STRUCT_FEATURE_VALID,   '.T.'))               //Validação de Campo    
