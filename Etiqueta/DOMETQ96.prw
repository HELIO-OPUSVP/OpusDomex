...
ฑฑบPrograma  ณ DOMETQ96 บAutor  ณ Michel A. Sander   บ Data ณ  07.02.2017 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Etiqueta de Embalagem Nivel 3 CLIENTE PADTEC (Expedi็ใo)   บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุอออออออออออegอออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ P11                                                        บฑฑ
...
User Function DOMETQ96(cNumOP,cNumSenf,nQtdEmb,nQtdEtq,cNivel,aFilhas,lImpressao,nPesoVol,cVolumeAtu,lColetor,cNumSerie,cNumPeca,cItemPed)
...
//Grade de Itens
MSCBBOX(05,23,113,86,3,"B")
//Grade do Cabe็alho dos Itens
MSCBBOX(05,29,113,29,3,"B")

//Grade do 1o. Item
MSCBBOX(14,23,14,86,3,"B")
//Grade do 1o. Produto
MSCBBOX(46,23,46,86,3,"B")
//Grade da 1o. Quantidade
MSCBBOX(59,23,59,86,3,"B")
//Grade do 2o. Item
MSCBBOX(68,23,68,86,3,"B")
//Grade do 2o. Produto
MSCBBOX(100,23,100,86,3,"B")
...
SC6->(dbSetOrder(1))
SC6->(dbSeek(xFilial("SC6")+SUBSTR(XD1->XD1_PVSEP,1,6)+ALLTRIM(XD1->XD1_ITEM)))
...
MSCBSAY(nColV  ,nLin+12 ,"SITE:   " + Alltrim(SC6->C6_XXSITE)											 ,cRotacao,"0","26,26")
