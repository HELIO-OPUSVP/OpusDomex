...
±±ºPrograma  ³ DOMETQ83 ºAutor  ³ Michel A. Sander   º Data ³  08.11.2017 º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³ Etiqueta Modelo 28 - Junção Trunk 					           º±±
±±º          ³                                                            º±±
...
User Function DOMETQ83(cNumOP,cNumSenf,nQtdEmb,nQtdEtq,cNivel,aFilhas,lImpressao,nPesoVol,lColetor,cNumSerie,cNumPeca)
...
If ETQ->(Eof())
   ...
   Aviso("Atenção","Um ou mais Componentes da estrutura está sem o lado definido. Altere a estrutura e tente novamente.",{"Ok"})
	...
	cAssunto := "Etiqueta Layout 083 - Junção Trunk 28"
...
For x := 1 to nChoice
   ...
   Do While ETQ->(!Eof())
      ...
      If ETQ->G1_XXQTET1 > 0
	      ...
	      For y := 1 to nDobra
//	      For y := 1 to (ETQ->G1_XXQTET1 * nDobra)
      ...
      If ETQ->G1_XXQTET2 > 0
	      ...
	      For y := 1 to nDobra
//	      For y := 1 to (ETQ->G1_XXQTET2 * nDobra)
