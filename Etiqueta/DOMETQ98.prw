...
User Function DOMETQ98(cNumOp ,cNumSenf, nQtdEmb, nQtdEtq, cNivel, aFilhas , lImprime, _PesoAuto, lCtor, cNumSerie, cNumPeca, cSetor,cEtqHuawei,cVolumeAtu,cNumpedido)
	...
	If ISINCALLSTACK('U_DOMACW46') .and. cfilant == "02
		cLocImp:= "000032"
		DOMETQ98A(cNumOp ,cNumSenf, nQtdEmb, nQtdEtq, cNivel, aFilhas , lImprime, _PesoAuto, lCtor, cNumSerie, cNumPeca, cSetor,cEtqHuawei,cVolumeAtu,cNumpedido,cLocImp)
		Return
	ElseIf ISINCALLSTACK('U_DOMACW22') .and. cfilant == "02
		cLocImp:= "000024"
		DOMETQ98A(cNumOp ,cNumSenf, nQtdEmb, nQtdEtq, cNivel, aFilhas , lImprime, _PesoAuto, lCtor, cNumSerie, cNumPeca, cSetor,cEtqHuawei,cVolumeAtu,cNumpedido,cLocImp)
		Return
	ENDIF
...
Static Function DOMETQ98A(cNumOp,cNumSenf, nQtdEmb, nQtdEtq, cNivel, aFilhas , lImprime, _PesoAuto, lCtor, cNumSerie, cNumPeca, cSetor,cEtqHuawei,cVolumeAtu,cNumpedido,cLocImp)
