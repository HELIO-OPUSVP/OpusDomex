...
ฑฑบPrograma  ณ DOMETQ16 บAutor  ณ Michel A. Sander   บ Data ณ  15/05/2014 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Etiqueta Modelo 16 (nใo grava XD1)                         บฑฑ
ฑฑบ          ณ                                                            บฑฑ
...
User Function DOMETQ16(cNumOP,cNumSenf,nQtdEmb,nQtdEtq,cNivel,aFilhas,lImpressao,nPesoVol,lColetor,cNumSerie,cNumPeca)
...
cSemana := WEEK->SEMANA
cWW     := StrZero(Val(SubsTr(cSemana,5,1)),2)
...
For x := 1 To mv_par03
	...
	ElseIf a == 3 	
	   cL10 += "PN: "+SC2->C2_PRODUTO+";"+"SN: "+cNumSerie+";"+cWW+cYY+";"
		...
		//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤxิ[ฟ
	    cOptions := "2;0;1;LAYOUT16"			// Parametro 1 (2= Impressora 1=Visualiza)
	   	
		//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤxิ[ฟ
		//ณExecuta Crystal Reports para impressใo			 	 ณ
		//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤxิ[ฟ
		CALLCRYS('LAYOUT016', cL10 ,cOptions)
	   a := 0
	   cNumSerie := Soma1(cNumSerie)
	EndIf
