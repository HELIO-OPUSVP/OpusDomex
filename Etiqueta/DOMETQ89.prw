...
ฑฑบPrograma  ณ DOMETQ89 บAutor  ณ Michel A. Sander   บ Data ณ  15/05/2014 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Etiqueta Modelo 16 (COM DATAMATRIX) (nใo grava XD1)        บฑฑ
ฑฑบ          ณ                                                            บฑฑ
...
User Function DOMETQ89(cNumOP,cNumSenf,nQtdEmb,nQtdEtq,cNivel,aFilhas,lImpressao,nPesoVol,lColetor,cNumSerie,cNumPeca)
...
cSemana := WEEK->SEMANA
cWW     := StrZero(Val(SubsTr(cSemana,5)),2)
...
For x := 1 To mv_par03
	...
	a := a + 1
	If a == 1
	   cL10 := "PN: "+SC2->C2_PRODUTO+";"+"SN: "+cNumSerie+";"+cWW+cYY+";"
	   cSerial1   := cNumSerie
	...
	ElseIf a == 3 	
	   ...
	   cNumSerie := Soma1(cNumSerie)
		...
		//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤxิ[ฟ
	    cOptions := "2;0;1;LAYOUT89"			// Parametro 1 (2= Impressora 1=Visualiza)
	   	
		//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤxิ[ฟ
		//ณExecuta Crystal Reports para impressใo			 	 ณ
		//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤxิ[ฟ
		CALLCRYS('LAYOUT089', cL10 ,cOptions)
		Sleep(1500)
	   a := 0
...
lResto := .F.
If a == 1
   cL10 := "PN: "+SC2->C2_PRODUTO+";"+"SN: "+cSerial1+";"+cWW+cYY+";"
   cL10 += "FINAL"+";"+"FINAL"+";"+"FINAL"+";"
   cL10 += "FINAL"+";"+"FINAL"+";"+"FINAL"+";"
   cL10 += cSerial1+";"+"FINAL"+";"+"FINAL"+";"
   lResto := .T.
ElseIf a == 2 	
   cL10 := "PN: "+SC2->C2_PRODUTO+";"+"SN: "+cSerial2+";"+cWW+cYY+";"
   cL10 += "PN: "+SC2->C2_PRODUTO+";"+"SN: "+cSerial3+";"+cWW+cYY+";"
   cL10 += "FINAL"+";"+"FINAL"+";"+"FINAL"+";"
   cL10 += cSerial1+";"+cSerial2+";"+"FINAL"+";"
   lResto := .T.
EndIf
