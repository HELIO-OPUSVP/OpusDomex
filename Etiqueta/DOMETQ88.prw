...
ฑฑบPrograma  ณ DOMETQ88 บAutor  ณ Michel A. Sander   บ Data ณ  15/05/2014 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Etiqueta Modelo 10 COM DATAMATRIX (nใo grava XD1)          บฑฑ
ฑฑบ          ณ                                                            บฑฑ
...
User Function DOMETQ88(cNumOP,cNumSenf,nQtdEmb,nQtdEtq,cNivel,aFilhas,lImpressao,nPesoVol,lColetor,cNumSerie,cNumPeca)
...
If lAchou
	...
	lAchou   := aRetAnat[1]
	aCodAnat := aRetAnat[2]
	/*Retirado a valida็ใo - solicitado por Denis - atendimento do chamado 015778	
...
For x := 1 To mv_par03
	...
	a := a + 1
	If a == 1
	   cL10 := "PN: "+SC2->C2_PRODUTO+";"+"OM: "+SC2->C2_NUM+SC2->C2_ITEM+SC2->C2_SEQUEN+";"+cWW+cYY+";"
	   cSerial1   := cNumSerie
	...
	ElseIf a == 3 	
	   ...
	   cNumSerie := Soma1(cNumSerie)
		...
		//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤxิ[ฟ
	   cOptions := "2;0;1;LAYOUT88"			// Parametro 1 (2= Impressora 1=Visualiza)
