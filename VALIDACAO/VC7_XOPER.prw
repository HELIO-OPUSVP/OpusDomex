...
±±ºPrograma  ³VC7_XOPER ºAutor  ³Helio/Marco Aurelio º Data ³  26/06/21   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³ Validação do campo C7_XOPER                                º±±
±±º          ³                                                            º±±
±±º          ³                                                            º±±
...
User Function VC7_XOPER()
	Local _Retorno := .T.
	Local nPC7_PRODUTO := aScan(aHeader,{ |aVet| Alltrim(aVet[2]) == "C7_PRODUTO" })

	SB1->( dbSetOrder(1) )
	If SB1->( dbSeek( xFilial() + aCols[N,nPC7_PRODUTO] ) )
