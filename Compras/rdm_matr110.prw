...
If AllTrim(mv_par06) == "B1_DESC"
	...
	cDescri := Alltrim(SB1->B1_DESCR1)
	//Alterado por JFS
	If !Empty(SB1->B1_DESCR2)
	   cDescri += " "+Alltrim(SB1->B1_DESCR2)
	EndIf
	If !Empty(SB1->B1_DESCR3)
	   cDescri += " "+Alltrim(SB1->B1_DESCR3)
	EndIf
	If !Empty(SB1->B1_DESCR4)
	   cDescri += " "+Alltrim(SB1->B1_DESCR4)
	EndIf
	If !Empty(SB1->B1_DESCR5)
	   cDescri += " "+Alltrim(SB1->B1_DESCR5)
    EndIf
	//Fim JFS
