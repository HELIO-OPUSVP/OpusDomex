...
±±ºPrograma  ³RELPROD7  ºAutor  ³Helio Ferreira      º Data ³  13/12/16   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³ O mesmo relatório do RELPROD5.prw reescrito para R4        º±±
±±º          ³                                                            º±±
±±º          ³ Relatório de Pedidos de Vendas totalizados por produtos    º±±
±±º          ³                                                            º±±
...
oReport   :=TReport():New("RELPROD7",cTitulo,cPerg,{|oReport| ReportPrin(oReport)},"Este relatório exibirá uma listagem de OFs.")
...
TRCell():New(oSection1,"B1_DESC"      ,,"Descrição"          , ,060,.F.,)
