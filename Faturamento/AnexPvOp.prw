...
±±ºPrograma  ³ ANEXPVOP ºAutor  ³Osmar Ferreira       º Data ³ 25/11/2021 º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³ Tela de consulta de documentos por Pedido de Venda  /      º±±
±±º          ³ Ordem de Produção                                          º±±
...
User Function AnexPvOp(cProduto)
...
Static Function ValidaProd(cProduto)
	...
	If lEncontrou
		...
		Else
            ...
            cCC := ""
            // Osmar cPara    := 'denis.vieira@rdt.com.br;monique.garcia@rosenbergerdomex.com.br;daniel.cavalcante@rosenbergerdomex.com.br;fabiana.santos@rosenbergerdomex.com.br;tatiane.alves@rosenbergerdomex.com.br;lucimar.silveira@rosenbergerdomex.com.br'
			// Osmar cCC      := 'natalia.silva@rosenbergerdomex.com.br;keila.gamt@rosenbergerdomex.com.br;leonardo.andrade@rosenbergerdomex.com.br;gabriel.cenato@rosenbergerdomex.com.br;luiz.pavret@rdt.com.br' //chamado monique 015475
			cArquivo := Nil
