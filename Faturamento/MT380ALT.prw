...
±±ºPrograma  ³MT380ALT  ºAutor  ³Osmar Ferreira     º Data ³  19/05/2020  º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³  Ponto de entrada que roda depois da gravação de uma       º±±
±±º          ³  alteração de Ajuste de Empenho Simples                    º±±
