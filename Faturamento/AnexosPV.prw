...
±±ºPrograma  ³AnexosPV  ºAutor  ³Helio / Osmar       º Data ³  17/11/21   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³ Botão de amarração de documentos (.doc, .pdf) ao cadastro  º±±
±±º          ³ de Pedido de Venda.                                        º±±
...
Static Function Visualizar()
	...
	If n > 0
		...
		If SZV->( dbSeek( xFilial() + "SC6" + cNPedido+cNItem ) )
			...
			cFileOri := cSlvAnexos+"\" +cNPedido+cNItem + "\" + SZV->ZV_ARQUIVO
