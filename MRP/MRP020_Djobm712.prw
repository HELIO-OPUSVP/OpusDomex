...
//�������������������������������������������u
	...
	cQrAlter := " UPDATE SB1010 SET B1_MRP='S'  "
    cQrAlter += " WHERE B1_COD IN (SELECT B1_ALTER FROM SB1010 WHERE B1_MRP='S' AND B1_ALTER<>'' AND D_E_L_E_T_='') "
    cQrAlter += " AND D_E_L_E_T_='' AND B1_FILIAL='"+xFILIAL('SB1')+"' "
	TCSQLEXEC(cQrAlter)
