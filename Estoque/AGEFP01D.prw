...
±±≥FunáÖo   ≥AGEFP01  ≥ Autor ≥ Mauricio Lima de Souza  ≥ Data ≥11/12/2008≥±±
±±√ƒƒƒƒƒƒƒƒƒƒ≈ƒƒƒƒƒƒƒƒƒƒ¡ƒƒƒƒƒƒƒ¡ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ¡ƒƒƒƒƒƒ¡ƒƒƒƒƒƒƒƒƒƒ¥±±
±±≥DescriáÖo ≥ Consulta Consumo Mensal                                    ≥±±
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±⁄ƒƒƒƒƒƒƒƒƒƒ¬ƒƒƒƒƒƒƒƒƒƒ¬ƒƒƒƒƒƒƒ¬ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ¬ƒƒƒƒƒƒ¬ƒƒƒƒƒƒƒƒƒƒø±±
±±≥FunáÑo    ≥CriaTmp   ≥ Autor ≥ MAURICIO LIMA DE SOUZA            ≥ Data ≥10/01/2001≥±±
±±√ƒƒƒƒƒƒƒƒƒƒ≈ƒƒƒƒƒƒƒƒƒƒ¡ƒƒƒƒƒƒƒ¡ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ¡ƒƒƒƒƒƒ¡ƒƒƒƒƒƒƒƒƒƒ¥±±
±±≥DescriáÑo ≥ Cria Arquivo Temporario                                    ≥±±
±±¿ƒƒƒƒƒƒƒƒƒƒ¡ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒŸ±±
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±⁄ƒƒƒƒƒƒƒƒƒƒ¬ƒƒƒƒƒƒƒƒƒƒ¬ƒƒƒƒƒƒƒ¬ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ¬ƒƒƒƒƒƒ¬ƒƒƒƒƒƒƒƒƒƒø±±
±±≥FunáÑo    ≥SD3Query  ≥ Autor ≥ MAURICIO LIMA DE SOUZA            ≥ Data ≥22/10/2000≥±±
±±√ƒƒƒƒƒƒƒƒƒƒ≈ƒƒƒƒƒƒƒƒƒƒ¡ƒƒƒƒƒƒƒ¡ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ¡ƒƒƒƒƒƒ¡ƒƒƒƒƒƒƒƒƒƒ¥±±
±±≥DescriáÑo ≥Query para arquivo de movimentacao de fabrica               ≥±±
±±¿ƒƒƒƒƒƒƒƒƒƒ¡ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒŸ±±
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
ﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂ
*/
...
While !Eof()
	...
	@ li, 0  pSay "TotalizaÁ„o por Tipos                              "+TIPO+"      " + ;
	Transform(VLR00_30  ,"@E  99,999,999,999.99")+" !! " + transform(VLR31_60  ,"@E 99,999,999,999.99")+" !! "+  	;
	Transform(VLR61_90  ,"@E  99,999,999,999.99")+" !! " + transform(VLR91_180 ,"@E 99,999,999,999.99")+" !! "+  	;
	Transform(VLR181_360,"@E  99,999,999,999.99")+" !! " + transform(VLR361_540,"@E 99,999,999,999.99")+" !! "+  	;
	Transform(VLR540    ,"@E  99,999,999,999.99")
...
While !Eof()
	...
	@ li, 0  pSay "TotalizaÁ„o por Grupos                                "+Grupo+" " +;
	Transform(VLR00_30  ,"@E  99,999,999,999.99")+" !! " + transform(VLR31_60  ,"@E 99,999,999,999.99")+" !! "+  	;
	Transform(VLR61_90  ,"@E  99,999,999,999.99")+" !! " + transform(VLR91_180 ,"@E 99,999,999,999.99")+" !! "+  	;
	Transform(VLR181_360,"@E  99,999,999,999.99")+" !! " + transform(VLR361_540,"@E 99,999,999,999.99")+" !! "+  	;
	Transform(VLR540    ,"@E  99,999,999,999.99")
