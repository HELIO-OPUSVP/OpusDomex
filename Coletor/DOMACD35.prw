...
±±ºPrograma  ³DOMACD08  ºAutor  ³Helio Ferreira      º Data ³ 			   º±±
±±º          ³                                                            º±±
...
User Function DOMACD35()
	...
	@ 024,005 Say oTxtProdEmp  Var "Código: " + _cProdEmp Pixel Of oTelaOP
	@ 024,077 Say oTxtQtdEmp   Var "Qtd: " + TransForm(_nQtdEmp,"@E 999,999.99") Pixel Of oTelaOP
	@ 030,005 Say oTxtDescric  Var "Descrição: " + _cDescric Size 110,15 Pixel Of oTelaOP
	@ 045,005 Say oTxtEnderec  Var "Endereço: "+ _cEnderec Pixel Of oTelaOP
...
Static Function fTelaEti()
	...
	Define MsDialog oTelaEti Title OemToAnsi("Correção Etiqueta") From 0,0 To 265,233 Pixel of oMainEti PIXEL
