...
±±ºPrograma  ³DOMACD41  ºAutor  ³Michel A. Sander    º Data ³  01/11/17   º±±
...
DEFINE MSDIALOG oTrans TITLE OemToAnsi("Entrega de Bobina Filial MG") FROM 0,0 TO 293,233 PIXEL OF oMainWnd PIXEL
