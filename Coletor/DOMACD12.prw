...
Static Function fOkTela()
	*----------------------------------------------------------
	...
	Define MsDialog oSenf Title OemToAnsi("Pagamento de Senf " + DtoC(dDataBase)) From 0,0 To 293,233 Pixel of oMainWnd PIXEL

	@ 005,005 Say   oTxtOF  Var "OF " Pixel Of oSenf
	oTxtOF:oFont := TFont():New('Arial',,17,,.T.,,,,.T.,.F.)


	@ 005,030  BITMAP oBmp1 ResName "RIGHT"  Of oMainWnd Size 090,20 ON CLICK BUSCAPVSEP("PC")  NoBorder  Pixel


	@ 005,045 MsGet oGetPC  Var _cPedido Valid fValop() Size 70,10 Pixel Of oSenf
	oGetPC:oFont := TFont():New('Arial',,20,,.T.,,,,.T.,.F.)


	@ 020,005 Say oTxtCliente  Var _cTxtCliente      Pixel Of oSenf
	oTxtCliente:oFont:= TFont():New('Arial',,17,,.T.,,,,.T.,.F.)

	@ 035,030  BITMAP oBmp2 ResName "RIGHT"  Of oMainWnd Size 090,20 ON CLICK BUSCAPVSEP("IT")  NoBorder  Pixel


	@ 035,005 Say   oTxtITEM Var "Item" Size 014,10 Pixel Of oSenf
	oTxtITEM:oFont:= TFont():New('Arial',,17,,.T.,,,,.T.,.F.)



	@ 035,045 MsGet oGetItem Var _cItem  Size 070,10 Valid fValITEM() Pixel Of oSenf
	oGetItem:oFont:= TFont():New('Arial',,20,,.T.,,,,.T.,.F.)



	@ 050,005 Say oTxtPRODCOD  Var _cTxtPRODCOD      Pixel Of oSenf
	oTxtPRODCOD:oFont:= TFont():New('Arial',,17,,.T.,,,,.T.,.F.)

	@ 060,005 Say oTxtPRODDES  Var _cTxtPRODDES      Pixel Of oSenf
	oTxtPRODDES:oFont:= TFont():New('Arial',,17,,.T.,,,,.T.,.F.)

	@ 070,005 Say oTxtPRODEND  Var _cTxtPRODEND      Pixel Of oSenf
	oTxtPRODEND:oFont:= TFont():New('Arial',,17,,.T.,,,,.T.,.F.)

	@ 080,005 Say oTxtPREND Var _cTxtPREND     Pixel Of oSenf
	oTxtPREND:oFont:= TFont():New('Arial',,17,,.T.,,,,.T.,.F.)

	@ 095,005 Say   oTxtEndereco Var "Endereço "  Pixel Of oSenf
	@ 095,045 MsGet oGetEndereco Var _cEndereco  Valid fValEnd() Size 70,10  Pixel Of oSenf
	oTxtEndereco:oFont:= TFont():New('Arial',,17,,.T.,,,,.T.,.F.)
	oGetEndereco:oFont:= TFont():New('Arial',,20,,.T.,,,,.T.,.F.)

	@ 110,005 Say   oTxtEtiqueta  Var "Etiqueta "  Pixel Of oSenf
	@ 110,045 MsGet oGetEtiq      Var _cEtiqueta Valid fValEtiq() Size 70,10  Pixel Of oSenf
	oTxtEtiqueta:oFont:= TFont():New('Arial',,17,,.T.,,,,.T.,.F.)
	oGetEtiq:oFont:= TFont():New('Arial',,20,,.T.,,,,.T.,.F.)

	@ 125,005 Say   oTxtQtd  Var "Quantidade " Pixel Of oSenf
	@ 125,045 MsGet oGetQtd  Var _nQtd Valid fValQTD()      Picture "@E 9,999,999.9999" Size 70,10  Pixel Of oSenf
