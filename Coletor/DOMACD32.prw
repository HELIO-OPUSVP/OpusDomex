...
±±ºPrograma  ³DOMACD32  ºAutor  ³Michel A. Sander    º Data ³  01/11/17   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³ Devolução de bobinas de fibra para o estoque               º±±
±±º          ³                                                            º±±
...
DEFINE MSDIALOG oTrans TITLE OemToAnsi("Devolução de Bobina ao Estoque") FROM 0,0 TO 293,233 PIXEL OF oMainWnd PIXEL
...
If !Empty(_cEtiqueta)
	...
	If XD1->( dbSeek( xFilial("XD1") + _cEtiqueta ) )
		...
		IF XD1->XD1_QTDATU<=0
			...
			RETURN
		ENDIF
		IF alltrim(XD1->XD1_LOCALI)<> alltrim(_cEndOrig)æ
