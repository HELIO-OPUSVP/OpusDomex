...
ฑฑบPrograma  ณ DOMACD22 บAutor  ณ Jackson Santos    บ Data ณ  13.01.2022 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Paletiza็ใo via coletor de dados Ajustar para misturar    บฑฑ
ฑฑบ          ณ 	Produtos de outra OP.                                    บฑฑ
		...
		Else
			...
			If aScan(aPalBip,{ |aVet| aVet[1] == cEtiqueta }) == 0
				...
				If Empty(cOpAtual) .Or. cOpAtual == SC2->C2_NUM + SC2->C2_ITEM + SC2->C2_SEQUEN
					...
					/*else
						U_MsgColetor("Nใo ้ possํvel misturar OP na Paletiza็ใo")
						cEtiqueta := Space(_nTamEtiq)
						oEtiqueta:Refresh()
						oEtiqueta:SetFocus()					
						Return (.f.)	
...
SB1->(dbSetOrder(1))
	...
	If lEhFuruka .or.  ALLTRIM(SB1->B1_GRUPO) $ "DROP/PCON/FTTA" 
