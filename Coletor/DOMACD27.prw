...
Private _cNumOp     := Space(_nTamDanfe)
...
@ nLin-2,020 MsGet __oGetNF  Var _cNumOp Valid VldOP() Size 095,10 Pixel Of __oTelaNF
...
@ 032,001 To 132,115 Pixel Of oMainWnd PIXEL
...
nLin += 20
@ nLin,005 Say oTxtVal  Var "Total da NF: "      Pixel Of __oTelaNF
@ nLin,035 say oTxtTot  Var _nValNF  Size 075,15 Pixel Of __oTelaNF
oTxtTot:oFont := TFont():New('Arial',,14,,.T.,,,,.T.,.F.)
nLin+= 15
...
ÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜ            '
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณ VldOp    บAutor  ณHelio Ferreira      บ Data ณ  15/06/15   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Valida็ใo da OP coletada										     บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ                                                            บฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
...
If XD1->(dbSeek(xFilial("XD1")+_cNumEtqPA))
	...
	If aScan(aEmbBip,{ |aVet| aVet[1] == _cNumEtqPA }) == 0
		...
		If nLido == nVolDanfe
		   If U_uMsgYesNo("Carga completa. Imprimir etiqueta de transportadora?")
				ImpEtqDanfe()
			EndIf	
			_cNumNFS  := ""
		   _nValNF   := ""
