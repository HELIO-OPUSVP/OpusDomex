...
// Rotina 20
	If aScan(aAcessos,20) <> 0
		Private oBtn03 := Nil
		@ nLin, nCol BUTTON oBtn03 PROMPT "EndereÁamento Recebimento" ACTION Processa( {|| IF(cAmbiente $ U_WEBCOL(), U_DOMACW01(), U_())} ) SIZE nLargBut,nAltuBut PIXEL OF oScroll //oDlgMenu01
